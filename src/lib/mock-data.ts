...
export const products: Product[] = [
  ...
  },
  {
    id: 'prod_2',
    name: 'لباس شب حریر',
    description: 'لباس شب بلند از پارچه حریر با طراحی زیبا و رنگ صورتی ملایم.',
    price: 4500000,
    inventory: 5,
  ...
  },
  {
    ...
    description: 'گلدان سرامیکی دست‌ساز با طراحی مینیمال برای دکوراسیون داخلی.',
    price: 950000,
    inventory: 20,
    images: ['https://placehold.co/600x600.png'],
    categoryId: '4',
  ...
  },
  {
    id: 'prod_8',
    name: 'آباژور رومیزی',
    description: 'آباژور با پایه چوبی و شید پارچه‌ای، مناسب برای اتاق خواب.',
    price: 1200000,
    inventory: 7,
    images: ['https://placehold.co/600x600.png'],
    categoryId: '4',
